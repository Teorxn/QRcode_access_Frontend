...
export default function Sidebar({ isOpen = false, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-[260px] bg-[#2b4592] text-white flex flex-col flex-shrink-0 h-full shadow-xl transform transition-transform duration-200 lg:sticky lg:top-0 lg:h-auto lg:min-h-screen lg:translate-x-0 lg:shadow-none ${
      ...
      >
        <div className="flex items-center px-6 py-[30px] gap-3">
          ...
          <div className="flex flex-col">
            <span className="font-bold text-[1.1rem] leading-tight">
              Control Acceso
            </span>
            <span className="text-[0.75rem] text-[#aebce5]">
              I.U. Pascual Bravo
            </span>
          </div>
          <button
          ...
          {user && (
            <div className="flex items-center gap-3 px-4 py-3 mb-3 rounded-lg bg-white/5">
              ...
              <div className="flex flex-col overflow-hidden">
                ...
                <span className="text-[0.7rem] text-[#aebce5] capitalize">
                  {user.rol}
                </span>
              </div>
            </div>
